...
filepath  = "C:/Users/matth/Documents/objectdetection/SeaDronesSee_SOT/annotations_json/instances_val_objects_in_water.json"
savefolder = "C:/Users/matth/Documents/objectdetection/SDSMOT/labels/val/"
import json
with open(filepath, "r") as f:
    ...
    for i in g["annotations"]:
        ...
        file = open(f"{savefolder}{i['image_id']}.txt", "a")
